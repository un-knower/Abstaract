...
import ruc.irm.similarity.sentence.editdistance.XiatianEditDistance2;
...
//    }
	...
	*/
		...
		SuperString<CharEditUnit> s1 = SuperString.createCharSuperString("ent");
		SuperString<CharEditUnit> s2 = SuperString.createCharSuperString("circ");
		...
		System.out.println((ed1.getEditDistance(s1, s2)));
		...
		System.out.println((new Date().getTime()-time));
		System.out.println((ed2.getEditDistance(s1, s2)));
		time = new Date().getTime();
		for(int i=0; i<100; i++){
			ed3.getEditDistance(s1, s2);			
		}
		System.out.println((new Date().getTime()-time));
		System.out.println((ed3.getEditDistance(s1, s2)));
	}
}
